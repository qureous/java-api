...
public class ContactAPI {
     ...
     *
     * @param contact {@link Contact} to be added
     ...
     * @param organization Organization name of the {@link Contact}
     * @param email        Email of the {@link Contact}
     * @param title        Designation of the {@link Contact}
     * @param phone        Phone number of the {@link Contact}
     * @param website      Web URL of the {@link Contact}
     * @return Added {@link Contact}
     * @throws Exception
     */
     ...
     *
     * @param contactId {@link String} id of the {@link Contact}
     * @return {@link Contact}
     * @throws Exception
     */
    public Contact getContact(String contactId) throws Exception {
        logger.debug("Getting contact by id ----------------");
     ...
     *
     * @param email {@link String} email of the {@link Contact}
     * @return {@link Contact}
     * @throws Exception
     */
    public Contact getContactFromEmail(String email) throws Exception {
        logger.debug("Getting contact by email ----------------");
     ...
     *
     * @param contactId     {@link String} id of the {@link Contact}
     * @param contactFields {@link Map} which contact fields to be updated
     * @param customFields  {@link Map} which contains custom fields to be added to
     *                      {@link Contact}
    ...
    public Contact updateContact(String contactId,
        ...
        logger.debug(new JSONObject(new ObjectMapper()
                .writeValueAsString(contact)).toString());
     ...
     *
     * @param contact {@link Contact} with the changes
     * @return Updated {@link Contact}
     * @throws Exception
     */
     ...
     *
     * @param contactId {@link String} id of the existing contact
     * @throws Exception
     */
    public void deleteContact(String contactId) throws Exception {
        logger.debug("deleting contact by id -----------------");
     ...
     *
     * @param contactIds {@link List} of {@link String} contact id's to be deleted
     * @throws Exception
     */
    public void deleteBulkContacts(List<String> contactIds) throws Exception {
        logger.debug("Bulk delete contacts -----------------------");
     ...
     *
     * @param tags       {@link List} of {@link String} tags to be added
     * @param contactIds {@link List} of {@link String} contact id's to which tags are
     *                   added
     * @throws Exception
     */
    public void addTagsToContacts(List<String> tags, List<String> contactIds)
            throws Exception {
        logger.debug("Adding tags to contacts based on contact id's ----");
     ...
     *
     * @param tag   {@link Tag} to be added to {@link Contact}
     * @param email {@link String} email of the {@link Contact}
     * @throws Exception
     */
    public void addTagsToEmail(Tag tag, String email) throws Exception {
        logger.debug("Adding tags to contact based on email ------------------");
     ...
     * @param contactFields {@link Map} of contact fields to be set to contact
     ...
     *
     * @param contact      {@link Contact}
     * @param customFields {@link Map} of custom fields to be set to contact
     * @return {@link Contact} after setting fields
     */
