...
public class DealAPI {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DealAPI.class);
     ...
     *
     * @param dealName    {@link String} name of the {@link Deal}
     * @param probability {@link Integer} probability value of the {@link Deal}
     * @param dealValue   {@link String} value of the {@link Deal}
     * @param mileStone   {@link String} milestone of the {@link Deal}
     * @return Added {@link Deal}
     * @throws Exception
     */
     ...
     * @param dealValue   {@link String} value of the {@link Deal}
     * @param mileStone   {@link String} milestone of the {@link Deal}
     * @param contactIds  {@link List} of {@link String} contact id's to be related to
     *                    {@link Deal}
     * @return Added {@link Deal}
     * @throws Exception
     */
     ...
     *
     * @param dealId {@link String} id of the {@link Deal}
     * @return {@link Deal}
     * @throws Exception
     */
    public Deal getDealByDealId(String dealId) throws Exception {
        logger.debug("Getting deal by id ---------------------------");
...
//		.accept(MediaType.APPLICATION_XML).get(Deal.class);
     ...
     *
     * @param deal {@link Deal} with the changes
     ...
     *
     * @param dealId {@link String} id of the existing deal
     * @throws Exception
     */
    public void deleteDealByDealId(String dealId) throws Exception {
        logger.debug("Deleting deal --------------------------------");
     ...
     *
     * @param dealIds {@link List} of {@link String} deal id's to be deleted
     * @throws Exception
     */
    public void deleteDeals(List<String> dealIds) throws Exception {
        logger.debug("Bulk delete deals -------------------------");
