...
public class NoteAPI {
     ...
     * parameters
     *
     * @param subject     {@link String} subject of the {@link Note}
     * @param description {@link String} description of the {@link Note}
     * @param contactIds  {@link List} of {@link String} id's of the {@link Contact} to
     *                    which note is added
     ...
     *
     * @param note       {@link Note} object to be added
     * @param contactIds {@link List} of {@link String} id's of the {@link Contact}
     * @return Added {@link Note}
     * @throws Exception
     */
    ...
    public List<Note> getNotesByContactId(String contactId) throws Exception {
        logger.debug("Getting notes by contact id --------------------");
     ...
     *
     * @param contactId {@link String} id of the {@link Contact}
     * @param noteId    {@link String} id of the {@link Note}
     * @throws Exception
     */
